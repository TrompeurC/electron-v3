export default {
	login: {
    info: "customer's relation management system",
    introduce: "Make the business more efficient and accelerate the digital upgrading of enterprises",
		describe: 'Electron + Vue3 based front-end solutions in the background.',
		signInTitle: 'Sign in',
    account: 'account',
    password: 'password',
    captcha: 'captcha',
    ...
    phoneError: 'Phone number input error',
